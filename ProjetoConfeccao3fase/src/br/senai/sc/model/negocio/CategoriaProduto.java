...
public class CategoriaProduto {
    ...
    public String toString() {
        return "CategoriaProduto{" + "codCategoriaProduto=" + codCategoriaProduto + ", nomeCategoriaProduto=" + nomeCategoriaProduto + ", descricaoCategoriaProduto=" + descricaoCategoriaProduto + '}';
    }
}
