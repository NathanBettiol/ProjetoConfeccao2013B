...
public class TesteNotaFiscal {
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "NOTA FISCAL"
                + "\nNumero da nota:" + n2.getCodNumero()
                + "\nData da emissão:" + n2.getDataEmissao()
                + "\nProdutos:" + n2.getProdutos()
                + "\nFuncionario Responsavel:" + n2.getFuncionarioResponsavel()
                + "\nDestinatario:" + n2.getDestinatario()
                + "\nRemetente:" + n2.getRemetente());
