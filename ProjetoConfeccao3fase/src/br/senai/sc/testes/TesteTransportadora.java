...
public class TesteTransportadora {
    ...
    public static void main(String[] args) {
        ...
        trans1.setCod(Integer.parseInt(JOptionPane.showInputDialog("Informe um código: ")));
        ...
        trans2.setCod(Integer.parseInt(JOptionPane.showInputDialog("Informe um código: ")));
