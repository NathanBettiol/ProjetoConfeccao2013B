...
public class InserirTransportadoraGUI extends javax.swing.JFrame {
     ...
     */
    public InserirTransportadoraGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InserirTransportadoraGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new InserirTransportadoraGUI().setVisible(true);
            }
        });
    }
}
